            <div style="background-color: black;" class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi" >Türkiye içinde ücretsiz kargo.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi" >Güvenli alışverişin tek adresi.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2 class="beyazyazi" >Uygun fiyatlar</h2>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2 class="beyazyazi" >24/7 Canlı destek</h2>
                                            <p class="beyazyazi" >Sorularınızı bize sorabilirsiniz class="beyazyazi" .</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                ...
                <div class="footer-static-middle">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        <li>
                                          ...
                                          <b style="color: white" href="tel://<?php echo $ayarcek['telefon'] ?>"><?php echo $ayarcek['telefon'] ?> </b> 
                                        </li>
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="beyazyazi" href="soru">Sık sorulan sorular</a></li>
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-block">
                                        <h3 style="color: white;" class="footer-block-title">Sosyal medya hesaplarımız</h3>
                                        <ul class="social-link">
                                            <li class="twitter">
                                                <a href="<?php echo $ayarcek['twitter'] ?>" data-toggle="tooltip" target="_blank" title="Twitter hesabımızı takip edebilirsiniz">
                                                    <i class="fa fa-twitter"></i>
                                                </a>
                                            </li>
                                            <li class="facebook">
                                                <a href="<?php echo $ayarcek['facebook'] ?>" data-toggle="tooltip" target="_blank" title="Facebook hesabımızı takip edebilirsiniz">
                                                    <i class="fa fa-facebook"></i>
                                                </a>
                                            </li>
                                            <li class="instagram">
                                                <a href="<?php echo $ayarcek['instagram'] ?>" data-toggle="tooltip" target="_blank" title="Instagram hesabımızı takip edebilirsiniz">
                                    ...
                                    <div class="footer-newsletter">
                                        <h4 class="beyazyazi">E-bültene abone olun</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="https://www.iremmedikal.com">İrem Medikal</a></span>
                                </div>
